# BENCHMARK: TRACE가 저장되는 directory
# BIN_FILE: 실행할 binary file (/workspace/workloads 이후부터 쓰기)

# trace는 /workspace/results/traces/${BENCHMARK}에 저장됨.
BENCHMARK=bert_inference
BIN_FILE="bert/inference_bert.py"
